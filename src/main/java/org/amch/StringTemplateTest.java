...
public class StringTemplateTest {
	static FamilyRelation type = FamilyRelation.FATHER;
	static String firstName = "Amor";
	static String lastName = "CHHIBI";
	static String childName = "Anass";
	...
	static void rawTemplateProcessor() {
		...
		String message = java.lang.StringTemplate.STR.process(st);
		// same as
	...
	static void simpleTemplate() {
		...
		System.out.println(STR."Wake up \{childName}...");
	...
	static void allowedExpressionsInsideEmbeddedTemplate() {
		...
		// call method
		System.out.println(STR."In what language his first program.\n? \{greetings()}");

		// ternary expression
		System.out.println(STR."As you can see Mr. \{
			isCaptured ? lastName : childName
